    ...
    <div v-else class="flex gap-4 overflow-x-auto pb-4">
      ...
      <div class="flex-shrink-0 w-80">
        <div class="bg-orange-100 dark:bg-slate-800 rounded-lg p-4 h-full">
          <h3
            class="font-semibold text-orange-900 dark:text-white mb-4 flex items-center justify-between"
          >
            ...
            <span
              class="text-xs bg-orange-200 dark:bg-slate-700 text-orange-800 dark:text-slate-300 px-2 py-1 rounded-full"
            >
          ...
          <div class="space-y-3 min-h-[200px]">
            ...
            >
              <div class="flex items-start justify-between mb-2">
                <h4
                  class="font-medium text-slate-900 dark:text-white text-sm line-clamp-2"
                >
      ...
      <div class="flex-shrink-0 w-80">
        <div class="bg-red-100 dark:bg-slate-800 rounded-lg p-4 h-full">
          <h3
            class="font-semibold text-red-900 dark:text-white mb-4 flex items-center justify-between"
          >
            <div class="flex items-center gap-2">
            ...
            <span
              class="text-xs bg-red-200 dark:bg-slate-700 text-red-800 dark:text-slate-300 px-2 py-1 rounded-full"
            >
      ...
      <div class="flex-shrink-0 w-80">
        <div class="bg-blue-100 dark:bg-slate-800 rounded-lg p-4 h-full">
          <h3
            class="font-semibold text-blue-900 dark:text-white mb-4 flex items-center justify-between"
          >
            <div class="flex items-center gap-2">
            ...
            <span
              class="text-xs bg-blue-200 dark:bg-slate-700 text-blue-800 dark:text-slate-300 px-2 py-1 rounded-full"
            >
      ...
      <div class="flex-shrink-0 w-80">
        <div class="bg-yellow-100 dark:bg-slate-800 rounded-lg p-4 h-full">
          <h3
            class="font-semibold text-yellow-900 dark:text-white mb-4 flex items-center justify-between"
          >
            <div class="flex items-center gap-2">
            ...
            <span
              class="text-xs bg-yellow-200 dark:bg-slate-700 text-yellow-800 dark:text-slate-300 px-2 py-1 rounded-full"
            >
      ...
      <div class="flex-shrink-0 w-80">
        <div class="bg-green-100 dark:bg-slate-800 rounded-lg p-4 h-full">
          <h3
            class="font-semibold text-green-900 dark:text-white mb-4 flex items-center justify-between"
          >
            <div class="flex items-center gap-2">
            ...
            <span
              class="text-xs bg-green-200 dark:bg-slate-700 text-green-800 dark:text-slate-300 px-2 py-1 rounded-full"
            >
...
const fetchConversations = async () => {
  ...
  try {
    ...
    if (cachedData) {
      ...
      console.log(
        `Conversas carregadas do cache: ${cachedData.length} registros`,
      );
      loading.value = false;
      return;
    }
    ...
    while (hasMorePages) {
      ...
      if (!Array.isArray(pageData)) {
        console.warn("Unexpected response format (expected array):", pageData);
        pageData = [];
      }
